...
// ── Static data for features not yet available via API ──────────────
                  ...
                  {STATIC_ANOMALIES.map((a,i) => (
                    <div key={i} className="anomaly-card" style={{'--sev': a.severity==='critical'?'#EF4444':a.severity==='high'?'#F59E0B':'#8B5CF6'}}>
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                        ...
                        <span style={{ color: a.severity==='critical'?'#EF4444':a.severity==='high'?'#F59E0B':'#8B5CF6', fontWeight: 800, fontFamily: 'monospace' }}>{a.spike}</span>
                      </div>
              ...
              <>
                ...
                <div className="lens-card">
                  <div className="sec-header">
                    ...
                    <span className="sec-badge">{((268400/300000)*100).toFixed(1)}% used</span>
                  </div>
                  <div style={{ margin: '12px 0' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                      <span>Budget: $300.0K</span>
                      <span>Actual: $268.4K</span>
                      <span>Remaining: $31.6K</span>
                    </div>
                    <div style={{ height: 8, background: '#1E293B', borderRadius: 4, overflow: 'hidden' }}>
                      <div style={{ height: '100%', width: '89.5%', background: 'linear-gradient(90deg,#10B981,#F59E0B,#EF4444)', borderRadius: 4 }} />
                    </div>
                  </div>
                </div>
